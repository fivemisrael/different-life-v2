...
$(function () {
    ...
    $('.door').on('click', function() {
        ...
        $.post('http://dl-carmenu/openDoor', JSON.stringify({
                doorIndex: doorIndex
            })
        );
    });
    ...
    $('.seat').on('click', function() {
        ...
        $.post('http://dl-carmenu/switchSeat', JSON.stringify({
                seatIndex: seatIndex
            })
        );
    });
    ...
    $('.window').on('click', function() {
        ...
        $.post('http://dl-carmenu/togglewindow', JSON.stringify({
    ...
    $('.engine').on('click', function() {
        if ($(this).parent().hasClass('disabled')) return;
        $.post('http://dl-carmenu/toggleengine', JSON.stringify({}));
    });
    ...
    document.onkeyup = function (data) {
        if (open) {
            ...
            if ((
                ...
                // Z or Esc
                $.post('http://dl-carmenu/escape', JSON.stringify({}));
            }
        }
    };
});
