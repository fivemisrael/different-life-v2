...
Config.Item = 'taco'
Config.Package = 'tacobag'
Config.StartTaco = 1800

Config.Blips = {
  {title="Taco", colour=2, id=478, size = 0.8, x = 11.1, y = -1605.68, z = 29.39},
}
...
Config.Tacocook = vector3(11.36, -1599.27, 29.39)

Config.Tacomake = vector3(15.51, -1598.46, 29.37)

Config.JobPoints = vector3(7.1, -1605.13, 29.37)
...
Config.SellFish = {x = -3277.79, y = 970.17, z = 8.3}
Config.SellTurtle = {x = 3807.85, y = 4478.86, z = 6.0}
Config.SellShark = {x = 2517.6 , y = 4218.0, z = 38.8}

Config.FishTime = {a = 5000, b = 15000}

Config.FishPrice = {a = 5, b = 10}
Config.TurtlePrice = {a = 15, b = 20}
Config.SharkPrice = {a = 25, b = 30}
