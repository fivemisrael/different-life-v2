...
Config.Payment = math.random(50, 125) -- How much you get paid when RN Jesus doesnt give you oxy, divided by 2 for when it does.
...
Config.OxyAmount = math.random(1, 4) -- How much oxy you get when RN Jesus gives you oxy. Default: 1.
