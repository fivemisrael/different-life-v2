...
function CircleZone:new(id, center, radius, options)
  options = options or {}
  local zone = {
    ...
    debugBlip = options.debugColor or false,
  ...
  PolyZone.Registered[id] = zone
  return zone
end

function CircleZone:CreateCircle(id ,center, radius, options)
  local zone = CircleZone:new(id, center, radius, options)
...
function IsCircleZoneExist(id)
  -- print(not PolyZone.Registered[id])
  if not PolyZone.Registered[id] then
    return false
  else
    return true
  end
...
exports("CreateCircle", function(id, center, radius, options)
  CircleZone:CreateCircle(id ,center, radius, options)
end)

exports("IsCircleZoneExist", function(CircleZoneId)
  IsCircleZoneExist(CircleZoneId)
end)